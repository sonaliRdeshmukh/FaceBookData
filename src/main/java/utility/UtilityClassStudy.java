...
public class UtilityClassStudy 
{
		...
		Reporter.log("For waiting the test case", true);;
		}
	    ...
	    File dest=new File("C:\\Users\\Admin\\eclipse-workspace\\FaceBook\\Screenshot-"+fileName+PolicyBazzar+".jpg");
		FileHandler.copy(src, dest);
		Reporter.log("caputring the test case screenshot ", true);
		...
		Reporter.log("scrolling the page", true);
		}
		...
		FileInputStream myFile= new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\FaceBook\\src\\main\\java\\pom\\NewFbData.properties");
